...
ilmerge /out:Rest.Foundation.dll RestFoundation.dll Newtonsoft.Json.dll Linq2Rest.dll /ver:2.5.0.0 /t:library /internalize /targetplatform="v4,C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.5" /keyfile:..\..\..\RestFoundation.snk /xmldocs
cd ..\..\..
echo.
